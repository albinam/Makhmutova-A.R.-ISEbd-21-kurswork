        ...
        public static void CreateDoc(WordInfo info)
        {
            using (WordprocessingDocument wordDocument = WordprocessingDocument.Create(info.FileName, WordprocessingDocumentType.Document))
            {
                ...
                foreach (var tour in info.Tours)
                {
                    ...
                    TableCell nameCell = new TableCell(new Paragraph(new Run(new Text(tour.TourName))));
                    TableCell countryCell = new TableCell(new Paragraph(new Run(new Text(tour.Country))));
                    TableCell toaCell = new TableCell(new Paragraph(new Run(new Text(tour.TypeOfAllocation))));
                    TableCell durationCell = new TableCell(new Paragraph(new Run(new Text(tour.Duration.ToString()))));
                    TableCell costCell = new TableCell(new Paragraph(new Run(new Text(tour.Cost.ToString()))));            
                    tourRow.Append(numberCell);
                    tourRow.Append(nameCell);
                    tourRow.Append(countryCell);
                    tourRow.Append(toaCell);
